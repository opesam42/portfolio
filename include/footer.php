...
<footer>
            ...
            <section class="main">
                <nav class="social">
                    <a href="https://linkedin.com/in/opeyemi-oluwagbemiga-2ba61423b" target="blank"><i class="fa fa-regular fa-github"></i> Github</a>
                    <a href="https://www.behance.net/gbengaopeyemi" target="blank"><i class="fa fa-regular fa-behance"></i> Behance</a>
                    <a href="https://github.com/opesam42" target="blank"><i class="fa fa-regular fa-linkedin"></i> LinkedIn</a>
                </nav>
                <div>
